  ...
  methods: {
    ...
    */
    ...
    creatFatLine (points, color, lineWidth, hasJoint = false) {
      ...
      const endGeometry = new THREE.SphereGeometry( 20, 8, 8 );
    ...
    init() {
      ...
      */
      ...
      let realGpsList2_0607 = due0607Gps(realGpsToModel0527.slice(9))
      ...
      realGpsLine1_0607.joint.position.set(realStack0607[0][0], realStack0607[0][1], realStack0607[0][2])
      ...
      realGpsLine2_0607.joint.position.set(realStack0607[1][0], realStack0607[1][1], realStack0607[1][2])
      realGpsLine2_0607.joint.scale.set(1.10522, 1.10522, 1.10522)
      realGpsLine2_0607.joint.rotation.set(0.01583, 0.01795, 0.00781) */
      let listGpsLastPart2 = realStack0607.slice(1)
      let scaleParam = Math.sqrt(Math.pow(listGpsLastPart2[0][0] - listGpsLastPart2[1][0],2) +
          Math.pow(listGpsLastPart2[0][1] - listGpsLastPart2[1][1],2) +
          Math.pow(listGpsLastPart2[0][2] - listGpsLastPart2[1][2],2)) /
        Math.sqrt(
        Math.pow(realGpsList2_0607[realGpsList2_0607.length - 1][0]-realGpsList2_0607[0][0],2) +
        Math.pow(realGpsList2_0607[realGpsList2_0607.length - 1][1]-realGpsList2_0607[0][1],2) +
        Math.pow(realGpsList2_0607[realGpsList2_0607.length - 1][2]-realGpsList2_0607[0][2],2))
      realGpsLine2_0607.position.set(listGpsLastPart2[0][0], listGpsLastPart2[0][1], listGpsLastPart2[0][2])
      realGpsLine2_0607.rotation.set(0.02223, 0.01023, 0.01818)
      realGpsLine2_0607.scale.set(scaleParam, scaleParam, scaleParam)
      realGpsLine2_0607.joint.position.set(listGpsLastPart2[0][0], listGpsLastPart2[0][1], listGpsLastPart2[0][2])
      realGpsLine2_0607.joint.rotation.set(0.02223, 0.01023, 0.01818)
      realGpsLine2_0607.joint.scale.set(scaleParam, scaleParam, scaleParam)
      ...
      this.gpsTransform0607.add(realGpsLine2_0607.joint)
      // 5月27日 各点埋深
      let deepList0527 = [
        1.51,
        1.84,
      ...
      function getLen() {
        ...
        let len1 = Math.sqrt(Math.pow(l1[0][0]-l1[1][0],2) + Math.pow(l1[0][1]-l1[1][1],2) + Math.pow(l1[0][2]-l1[1][2],2))*2.90793;
        let len2 = Math.sqrt(Math.pow(l2[0][0]-l2[1][0],2) + Math.pow(l2[0][1]-l2[1][1],2) + Math.pow(l2[0][2]-l2[1][2],2))*2.90793;
        console.log(len1)
        // 44.16589935223881
        console.log(len2)
        // 34.968990598337086
      ...
      this.gpsLocation0607.position.y += 1
      ...
      this.transformControls.attach( this.gpsTransform0607 );
      // 变换控制
