  ...
  methods: {
    ...
    */
    ...
    init() {
      ...
      *
      */
      console.log('realGpsList1_0607', realGpsList1_0607)
      console.log('realGpsList2_0607', realGpsList2_0607)
      console.log('realGpsToModel0527.slice(10)', realGpsToModel0527.slice(10))
      let realGpsLine2_0616 = this.creatFatLine(realGpsList2_0607.slice(0, -3), '#ee4422', 1, true)
      realGpsLine2_0616.position.set(realStack0613[1][0], realStack0613[1][1], realStack0613[1][2])
      realGpsLine2_0616.rotation.set(-0.01486, -0.00812, -0.01001)
      realGpsLine2_0616.scale.set(1.14177, 1.14177, 1.14177)
      realGpsLine2_0616.joint.position.set(realStack0613[1][0], realStack0613[1][1], realStack0613[1][2])
      realGpsLine2_0616.joint.rotation.set(-0.01486, -0.00812, -0.01001)
      realGpsLine2_0616.joint.scale.set(1.14177, 1.14177, 1.14177)
      ...
      let pointList0616 = [
        ...
        // [-16.04971, 3.10893, 0.12133],
        // [-2.02271, 5.49602, 7.62515]
      ]
