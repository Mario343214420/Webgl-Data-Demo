      ...
      <div class="tools-inner">
        ...
        <div class="data-show-group">
          <div class="pipe" v-if="gpsGroup">
            ...
            <div class="group">
              position: <br>
              x: <i class="x">{{gps0527Group.position.x}}</i>,<br>
              y: <i class="y">{{gps0527Group.position.y}}</i>,<br>
              z: <i class="z">{{gps0527Group.position.z}}</i>
            </div>
            <div class="group">
              rotation: <br>
              x: <i class="x">{{gps0527Group.rotation.x}}</i>,<br>
              y: <i class="y">{{gps0527Group.rotation.y}}</i>,<br>
              z: <i class="z">{{gps0527Group.rotation.z}}</i>
            </div>
            <div class="group">
              scale: <br>
              x: <i class="x">{{gps0527Group.scale.x}}</i>,<br>
              y: <i class="y">{{gps0527Group.scale.y}}</i>,<br>
              z: <i class="z">{{gps0527Group.scale.z}}</i>
            </div>
          </div>
        </div>
        <div>
  ...
  methods: {
    ...
    */
    ...
    init() {
      ...
      // console.log(0.8, deepList0527_0p8.map(item => item[1] * 2.907930598131183))
      // console.log(1.5, deepList0527_1p5.map(item => item[1] * 2.907930598131183))
      // console.log(deepLineList0527.map(item => item[1] * 2.907930598131183))
