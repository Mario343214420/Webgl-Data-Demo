...
<!--          <div class="btn" @click="gpsTransform0607.visible = !gpsTransform0607.visible">切换管线显隐</div>-->
    ...
    <div class="tools" :style="`right: ${toolsFlag ? '-340' : '20'}px;`">
      <div class="tools-inner">
        ...
        <div>
          <span @click="queryPipeRotPos">查看模拟管线状态</span>
        </div>
        <div>
          <div>放位点</div>
          <div class="marks">
...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      let drawPipe = (pl) => {
        let conversion = pl.map(item => [item[0] - 288187, item[1] - 4231044, -item[2] / 2.7])
        this.pipeListGroup.add(this.creatFatLine(conversion, '#ffffff', 1, true))
    ...
    clearMeasureMark() {},
    queryPipeRotPos() {
      console.log(this.pipeListGroup)
    }
  }
}
</script>
