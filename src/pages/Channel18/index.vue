  ...
  methods: {
    init() {
      ...
      list.forEach(item => {
        ...
        mesh.renderOrder = 3
        this.group.add(mesh)
        this.renderLine([item.name, item.info, mesh.safe ? '安全' : '不安全', '当前人数：' + mesh.count + '人'], item.position)
      })
...
3dtile.exe -f b3dm -i E:\projects\suligejingchang\set\Data\Tile_+008_+000\Tile_+008_+000.b3dm -o E:\projects\suligejingchang\008\Tile_+008_+000.gltf
    ...
    renderLine(textList, position) {
      ...
      lineGeometry.vertices.push(
        ...
        new THREE.Vector3( position.x + 100, 120, position.z - 100 )
      );
      ...
      sprite.position.set(position.x + 100, 160, position.z - 100)
