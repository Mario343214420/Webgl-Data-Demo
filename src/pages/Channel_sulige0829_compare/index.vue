  ...
  methods: {
    ...
    init() {
      ...
      let drawPipe = (pl) => {
        ...
        // if(hasJoint) {
        //   const geometryJoint = new THREE.SphereGeometry( 0.6, 8, 8 );
        //   const materialJoint = new THREE.MeshBasicMaterial( { color: 0xcc2222 } );
        //   const sphereJoint = new THREE.Mesh( geometryJoint, materialJoint );
        //   points.forEach(item => {
        //     let clone = sphereJoint.clone()
        ...
        //   })
        // }
        // this.pipeJointGroup.add(line.joint)
        // this.pipeListGroup.rotation.set(-1.5382, -0.0159, -1.0321)
        // this.pipeJointGroup.rotation.set(-1.5382, -0.0159, -1.0321)
        this.pipeListGroup.rotation.set(-1.5357, -0.0188, -1.0368)
        this.pipeJointGroup.rotation.set(-1.5357, -0.0188, -1.0368)
        // this.pipeListGroup.position.set(1592.62, 111.75, -873.26)
