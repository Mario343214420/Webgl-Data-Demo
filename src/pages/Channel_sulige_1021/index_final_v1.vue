...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      this.baseGroup = loadAllModel(list0822, '0822_simple', {x: -97.63837534956002, y: -1278.5395523400814, z: 1545.98137857454})
      ...
      this.compareGroup = loadAllModel(list1018, '1018_simple', {x: -93.14169082323335, y: -1277.9074312344567, z: 1484.4335890020654})
